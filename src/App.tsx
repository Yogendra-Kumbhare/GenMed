...
import { MedicineCabinetPage } from './components/pages/MedicineCabinetPage';
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-50/70 text-slate-800 antialiased flex flex-col selection:bg-teal-100 selection:text-teal-900">
