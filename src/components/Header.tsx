      ...
      <div className="px-4 sm:px-6 lg:px-8 py-3 flex items-center justify-between gap-4">
        ...
        <div className="flex-1 max-w-lg relative">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-9 py-2 bg-slate-50 hover:bg-slate-100/70 focus:bg-white text-sm text-slate-800 placeholder-slate-400 rounded-lg border border-slate-200 focus:border-teal-600 focus:outline-none focus:ring-2 focus:ring-teal-600/15 transition-all"
            />
            {searchQuery && (
              <button
                id="clear-search-btn"
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <button
            ...
            className="hidden md:inline-flex items-center gap-2 px-3 py-1.5 rounded-lg text-xs font-semibold text-teal-800 bg-teal-50 hover:bg-teal-100 border border-teal-200 transition-colors"
            title="Speak with on-duty licensed clinical pharmacist"
          >
            <PhoneCall className="w-3.5 h-3.5 text-teal-700 animate-pulse" />
